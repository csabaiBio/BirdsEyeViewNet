...
def compute_w_loader(file_path, output_path, wsi,save_folder, pretrained,
	...
	for count, (batch, coords) in enumerate(loader):
		with torch.no_grad():
			...
			asset_dict = {'imgs': batch.cpu().numpy()}
...
if __name__ == '__main__':
	...
	for bag_candidate_idx in range(10):
		...
		output_file_path = compute_w_loader(h5_file_path, output_path, wsi , args.save_folder, args.normalize,
