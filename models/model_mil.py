...
class MIL_fc(nn.Module):
    def __init__(self, gate = True, size_arg = "small", dropout = False, n_classes = 2, top_k=1, embedding_size=1000):
        super(MIL_fc, self).__init__()
        assert n_classes == 2
        self.size_dict = {"small": [embedding_size, 512]}
